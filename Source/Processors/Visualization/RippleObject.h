/*
  ==============================================================================
    ...
    RippleObject.h
    Created: 5 Jun 2013 2:45:05pm
    Author:  sethi-san

  ==============================================================================
*/

#ifndef __RIPPLEOBJECT_H_F4481115__
#define __RIPPLEOBJECT_H_F4481115__
#include <iostream>
#include <stdint.h>
#include <math.h>
#include "SpikeObject.h"

#define MAX_NUMBER_OF_RIPPLE_CHANNELS 4
#define MAX_NUMBER_OF_RIPPLE_CHANNEL_SAMPLES 512
#define CHECK_BUFFER_VALIDITY true
#define RIPPLE_EVENT_CODE 10;
#define MAX_RIPPLE_BUFFER_LEN 1024 // the true max calculated from the spike values below is actually 507
...
int packRipple(RippleObject* s, uint8_t* buffer, int bufferLength);

/** Simple method for deserializing a string of bytes into a Spike object, returns true is the provided spike buffer is valid */
bool unpackRipple(RippleObject *s, const uint8_t* buffer, int bufferLength);
...
#endif  // __RIPPLEOBJECT_H_F4481115__
