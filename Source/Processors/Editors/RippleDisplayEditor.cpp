...
#include "RippleDisplayEditor.h"
#include <string>

RippleDisplayEditor::RippleDisplayEditor(GenericProcessor* parentNode)
...
RippleDisplayEditor::~RippleDisplayEditor()
{
    deleteAllChildren();
}

void RippleDisplayEditor::initializeButtons()
{
    int w = 18;
    int h = 18;
    int xPad = 5;
...
Visualizer* RippleDisplayEditor::createNewCanvas()
{

    RippleDisplayNode* processor = (RippleDisplayNode*) getProcessor();
    return new RippleDisplayCanvas(processor);

}

// void RippleDisplayEditor::updateSettings()
// {
// 	// called by base class

// }

// void RippleDisplayEditor::updateVisualizer()
// {

// }

void RippleDisplayEditor::buttonCallback(Button* button)
{
    ...
    //             canvas->setParameter(Ripple_CMD_PAN_AXES, pIdx, i, 1);
    // }
    ...
    //     for (int i=0; i<nSubChannels; i++)
    //         if (subChanSelected[i])
    //             canvas->setParameter(Ripple_CMD_ZOOM_AXES, pIdx, i, -1);
    // }
    ...
    //     canvas->setParameter(Ripple_CMD_CLEAR_ALL, 0);
    // }
