...
#include "ParameterEstimatorEditor.h"
/*
    ------------------------------------------------------------------
...
ParameterEstimatorEditor::ParameterEstimatorEditor(GenericProcessor* parentNode, bool useDefaultParameterEditors=true)
...
ParameterEstimatorEditor::~ParameterEstimatorEditor()
{
...
void ParameterEstimatorEditor::sliderEvent(Slider* slider)
{
    int electrodeNum = -1;
...
void ParameterEstimatorEditor::buttonEvent(Button* button)
{
...
void ParameterEstimatorEditor::channelChanged(int chan)
{
...
bool ParameterEstimatorEditor::addElectrode(int nChans)
{
    ParameterEstimator* processor = (ParameterEstimator*) getProcessor();
...
void ParameterEstimatorEditor::removeElectrode(int index)
{
...
void ParameterEstimatorEditor::labelTextChanged(Label* label)
{
...
void ParameterEstimatorEditor::comboBoxChanged(ComboBox* comboBox)
{
